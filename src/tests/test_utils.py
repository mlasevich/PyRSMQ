...
class CmdUtilsUnitTests(unittest.TestCase):
    ...
    def test_validate_int(self):
        ...
        for value, min_value, max_value, expected in VALIDATE_INT_TESTS:
            self.assertEqual(expected, utils.validate_int(value, min_value, max_value))
    ...
    def test_validate_int_logging_too_low(self):
        ...
        self.assertEqual("testname value -1 is less than minimum (0)", logger.last_msg)
    ...
    def test_validate_int_logging_too_high(self):
        ...
        self.assertEqual(
            "testname value 101 is greater than maximum (100)", logger.last_msg
        )
    ...
    def test_validate_int_logging_invalid(self):
        ...
        self.assertEqual("testname value (A) is not an integer", logger.last_msg)
    ...
    def test_baseXencode(self):
        ...
        for raw, encoded, charset in BASE_X_ENCODED_TESTS:
            self.assertEqual(
                encoded,
                utils.baseXencode(raw, charset),
                "Invalid encoded value for base %s" % len(charset),
            )
